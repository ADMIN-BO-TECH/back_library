...
@Entity @Table(name = "preoperations", indexes = {
        ...
        @Index(name = "idx_preoperations_school_date", columnList = "school_id, preop_date")
})
public class Preoperation {
    ...
    // Congelados al momento del registro: el vehiculo puede cambiar de placa/RFID/colegio
    // despues, y el reporte historico debe reflejar lo que era ese dia, no lo que es hoy.
    ...
    // Denormalizados en el submit por PreoperationEvaluator: evitan un GROUP BY sobre
    // items en cada endpoint que solo necesita saber si la preop tuvo alguna novedad.
