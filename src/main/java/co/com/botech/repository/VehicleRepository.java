...
public interface VehicleRepository extends JpaRepository<Vehicle, Long> {
    ...
    @Query(value = """                                                                                                                                                                                                           
      SELECT      
          ...
          vd.mechanical_inspection_expiration AS mechanicalInspectionExpiration,
          vd.mileage          AS mileage,                                                                                                                                                                                          
          vd.mileage_last_updated AS mileageLastUpdated,                                                                                                                                                                           
          vd.vehicle_capacity AS vehicleCapacity,
    ...
    @Query(value = """
          ...
          LEFT JOIN vehicles_details vd                                                                                                                                                                                            
                 ON v.vehicle_id = vd.vehicle_id
          WHERE v.fleet_number in :fleetNumbers                                                                                                                                                                                    
          """, nativeQuery = true)
    List<VehicleCompleteResponse> findVehiclesCompleteByFleetNumberList(@Param("fleetNumbers") List<String> fleetNumbers);
}
